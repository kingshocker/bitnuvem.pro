...
var CorretoraPageModule = /** @class */ (function () {
    function CorretoraPageModule() {
    }
...
var CorretoraPage = /** @class */ (function () {
    function CorretoraPage(router, corretoraService) {
        this.router = router;
        this.corretoraService = corretoraService;
    }
    CorretoraPage.prototype.ngOnInit = function () {
        var idCorretora = this.router.snapshot.paramMap.get('idCorretora');
        this.corretora = this.corretoraService.corretoraPeloId(idCorretora);
    };
    CorretoraPage.ctorParameters = function () { return [
...
//# sourceMappingURL=corretora-corretora-module-es5.js.map