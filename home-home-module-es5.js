...
/***/ "./node_modules/angular-page-visibility/fesm5/angular-page-visibility.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/angular-page-visibility/fesm5/angular-page-visibility.js ***!
  \*******************************************************************************/
...
/** @type {?} */
var injector = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ReflectiveInjector"].resolveAndCreate(providers);
/** @type {?} */
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var angular_page_visibility__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! angular-page-visibility */ "./node_modules/angular-page-visibility/fesm5/angular-page-visibility.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
...
var HomePage = /** @class */ (function () {
    function HomePage(comunicacao, router, loadingController, changeDetectorRef, oportunidadesArbitragemService) {
    ...
    HomePage.prototype.ngOnDestroy = function () {
        ...
        if (!this.tempoRestantePararTarefa) {
            this.tempoRestantePararTarefa = setTimeout(function () {
                _this.arbitragensVerificadas = false;
                _this.oportunidadesArbitragemService.pararTarefa();
                _this.arbitragens = [];
                _this.oportunidadesArbitragemService.habilitarInicioImediato();
                _this.encerrarTempoRestantePararTarefa();
    ...
    HomePage.prototype.onPaginaVisivel = function () {
        this.propagadorPaginaVisivel.next(true);
    };
    HomePage.prototype.onPaginaNaoVisivel = function () {
        this.propagadorPaginaVisivel.next(false);
    };
    HomePage.prototype.iniciarTarefaVerificarOportunidadesArbitragem = function () {
        var _this = this;
        ...
        this.oportunidadesArbitragemService.inscrever(function (arbitragens) {
            _this.arbitragens = arbitragens;
            _this.arbitragensVerificadas = true;
            _this.fecharMensagemPaginaCarregando();
            _this.changeDetectorRef.detectChanges();
        });
    };
    HomePage.prototype.encerrarTempoRestantePararTarefa = function () {
        if (this.tempoRestantePararTarefa) {
            clearTimeout(this.tempoRestantePararTarefa);
        }
        this.tempoRestantePararTarefa = null;
    };
    HomePage.prototype.exibirMensagemPaginaCarregando = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.carregamento = _b.sent();
                        return [4 /*yield*/, this.carregamento.present()];
                    case 2:
                        _b.sent();
    ...
    HomePage.prototype.fecharMensagemPaginaCarregando = function () {
        if (this.carregamento) {
            this.carregamento.dismiss();
            this.carregamento = null;
        }
    };
    Object.defineProperty(HomePage.prototype, "existemOportunidadesAbitragem", {
        get: function () {
    ...
    HomePage.prototype.detalharOportunidadeArbitragem = function (indice) {
        var arbitragem = this.arbitragens[indice];
...
var OportunidadesArbitragemService = /** @class */ (function () {
    function OportunidadesArbitragemService(oportunidades, configuracoes, notificacaoService, backgroundMode, platform) {
    ...
    OportunidadesArbitragemService.prototype.enableBackgroundMode = function () {
        var _this = this;
    ...
    OportunidadesArbitragemService.prototype.criarTarefa = function () {
        var _this = this;
        ...
        if (!this.tarefaVerificarOportunidadesArbitragem) {
            this.tarefaVerificarOportunidadesArbitragem = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(this.UM_MINUTO_EM_MILISEGUNDOS).subscribe(function () {
                if (_this.paginaVisivel || _this.configuracao.permitirNotificar) {
                    _this.verificarOportunidadesArbitragem();
                }
            });
    ...
    OportunidadesArbitragemService.prototype.pararTarefa = function () {
        if (this.tarefaVerificarOportunidadesArbitragem) {
            this.tarefaVerificarOportunidadesArbitragem.unsubscribe();
            this.tarefaVerificarOportunidadesArbitragem = null;
        }
    };
    OportunidadesArbitragemService.prototype.recriarTarefa = function () {
        this.pararTarefa();
        this.criarTarefa();
    };
    OportunidadesArbitragemService.prototype.verificarOportunidadesArbitragem = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.tarefaFoiExecutada = true;
                this.oportunidades.verificarOportunidadesArbitragem().then(function (arbitragens) {
                    if ((_this.configuracao.permitirNotificar)
                        && (arbitragens.length > 0)
                        && ((!_this.paginaVisivel)
                            || ((_this.platform.is('cordova'))
                                && (_this.backgroundMode.isActive() === true)))) {
                        _this.notificacaoService.notificar(_this.NOTIFICACAO_TITULO, _this.NOTIFICACAO_MENSAGEM);
                        _this.pararTarefa();
                        _this.tempoRestanteNovaVerificacao = setTimeout(function () {
                            _this.criarTarefa();
                        }, (_this.UM_MINUTO_EM_MILISEGUNDOS
                            * _this.configuracao.tempoEntreNotificacoes));
                    }
                    _this.propagador.next(arbitragens);
                });
                return [2 /*return*/];
            });
        });
    };
    OportunidadesArbitragemService.prototype.inscrever = function (funcao) {
        return this.propagador.subscribe(funcao);
    };
    OportunidadesArbitragemService.prototype.observadorPaginaVisivel = function () {
        var _this = this;
        return (function (paginaVisivel) { return _this.paginaVisivel = paginaVisivel; });
    };
    OportunidadesArbitragemService.prototype.habilitarInicioImediato = function () {
        this.tarefaFoiExecutada = false;
    };
    OportunidadesArbitragemService.ctorParameters = function () { return [
    ...
    return OportunidadesArbitragemService;
}());
