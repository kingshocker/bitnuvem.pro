...
var ArbitragemPageModule = /** @class */ (function () {
    function ArbitragemPageModule() {
    }
...
var ArbitragemPage = /** @class */ (function () {
    function ArbitragemPage(comunicacao, arbitragemService, router) {
        this.comunicacao = comunicacao;
        this.arbitragemService = arbitragemService;
        this.router = router;
    }
    ArbitragemPage.prototype.ngOnInit = function () {
        this.comunicacao.propagadorObservavel.subscribe(this.carregarArbitragem());
        if (this.arbitragem) {
            var corretoraVenda = this.arbitragem.corretoraVenda;
            var corretoraCompra = this.arbitragem.corretoraCompra;
            this.titulo = corretoraVenda.nome + " x " + corretoraCompra.nome;
        }
    };
    ArbitragemPage.prototype.carregarArbitragemDiretamente = function () {
        var _this = this;
        var idCorretoraVenda = this.router.snapshot.paramMap.get('idCorretoraVenda');
        var idCorretoraCompra = this.router.snapshot.paramMap.get('idCorretoraCompra');
        this.arbitragemService.verificarOportunidadesArbitragemCorretorasPelosIds(idCorretoraVenda, idCorretoraCompra).then(function (arbitragem) { return _this.arbitragem = arbitragem; });
    };
    ArbitragemPage.prototype.carregarArbitragem = function () {
        var _this = this;
        return function (arbitragem) {
            if (arbitragem !== null) {
                _this.arbitragem = arbitragem;
            }
            else {
                _this.carregarArbitragemDiretamente();
            }
        };
    };
    ArbitragemPage.ctorParameters = function () { return [
...
var InformacoesArbitragemComponent = /** @class */ (function () {
    function InformacoesArbitragemComponent() {
        this.PRECISAO_REAL = '1.2-2';
        this.PRECISAO_BITCOIN = '1.0-8';
        this.cssClass = 'row';
    }
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "investimento", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "lucro", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "porcentagemLucro", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "possuiTaxaTransferencia", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "taxaTransferencia", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "possuiTaxaSaque", {
        get: function () {
    ...
    Object.defineProperty(InformacoesArbitragemComponent.prototype, "taxaSaque", {
        get: function () {
    ...
    return InformacoesArbitragemComponent;
}());
...
var InformacoesCorretoraComponent = /** @class */ (function () {
    function InformacoesCorretoraComponent() {
    ...
    return InformacoesCorretoraComponent;
}());
...
var TabelaOrdensComponent = /** @class */ (function () {
    function TabelaOrdensComponent() {
        this.PRECISAO_REAL = '1.2-2';
        this.PRECISAO_BITCOIN = '1.0-8';
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=arbitragem-arbitragem-module-es5.js.map