...
@Component({
  ...
  templateUrl: './configuracao-ordenacao.component.html',
  styleUrls: ['./configuracao-ordenacao.component.scss'],
})
export class ConfiguracaoOrdenacaoComponent implements OnInit {
